export MOAR='--style=github-dark --wrap --statusbar=bold --no-linenumbers'
export PAGER=moar
...
export PATH=$HOME/.config/rofi/scripts:$HOME/ansible-desktop/bin:$PATH
...
alias edhosts='sudo lvim /etc/hosts'
...
# User configuration
ZSH_AUTOSUGGEST_HIGHLIGHT_STYLE="fg=15,bold"
